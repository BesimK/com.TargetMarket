...
public class HomeDecorationPage extends BasePage {

	@FindBy(xpath = "//div[1]/h1/strong")
	private WebElement headerOfHomeDecorationPage;
	...
	public HomeDecorationPage() {
		super();
	}

	public String getHeaderOfHomeDecorationPage() {
		return headerOfHomeDecorationPage.getText();
	}
