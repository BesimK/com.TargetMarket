...
/**
 * 1. Open Browser, Navigate and Login to Target Market 2. Click on Women Dresses Tab 3.
 * Add Product/Products to Cart 4. Assert Product Added to Cart Dialogue is Displayed 5.
 * Assert Cart Counter 6. Click On Cart Button 7. Click On Checkout 8. Place Order with
 * Valid Credentials 9. Assert Successful Order Placement Dialogue at Home Page 10. Assert
 * Cart counter is 0 11. Scroll Up
 */
public class TC_024_WD_01 extends Hooks {
	...
	private Object[][] differentCases() {
		return new Object[][] { { 5, 1, 4, 2, 3 }, { 1 }, { 3, 2, 1 }, { 5 } };
	}
