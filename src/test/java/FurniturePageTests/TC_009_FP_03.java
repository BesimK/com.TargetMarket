...
/**
 * 1. Open Browser, Navigate and Login to Target Market 2. Add all products ro
 * ShoppingCart 3.Verify that all products added to ShoppingCart 4.Remove all items in
 * Shoping Cart List 5.Verify that Shopping card is empty
 */

public class TC_009_FP_03 extends Hooks {
