 ...
 * button. 4. Click on the "Sort By" button and select the "Highest Price" option. 5.
 * Verify that the products are sorted in decreasing order on the page.
 */
public class TC_019_SP_01 extends Hooks {
	...
	void verifySortByDropdownListFunctionality() {
		...
		// Verify that the products are sorted in decreasing order on the page.
		boolean areSmartphonesSortByHighestPrice = pages.getSmartphonesPage()
			.areSmartphonesSortByHighestPriceCorrectly();
