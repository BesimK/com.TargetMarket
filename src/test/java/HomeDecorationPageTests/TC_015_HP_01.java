...
public class TC_015_HP_01 extends Hooks {

	/**
	 * 1. Launch the application 2. Navigate to the Target Market 3. Use login data with
	 * standard_user 4. Use password data with secret_password 5. Click. The login button
	...
	void homeDecorationSingleProduct() throws Exception {
		...
		/*
		 * try{ //Buttons start with 1
		 * pages.getWomenDressesPage().clickAddToCartButton(1,2,3); }catch
		 * (ArrayIndexOutOfBoundsException arrayIndexOutOfBoundsException){
		 * Assert.fail("There is not that much product"); }catch (Exception exception){
