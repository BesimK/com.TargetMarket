 ...
 * 3. Click on the "Laptops" button.
 * 4. Click on the "Microsoft Surface Laptop 4" Add to Cart button.
 * 5. Verify that the product is added in shopping cart icon.
 * 6. Click on the shopping cart icon.
 * 7. Verify that the product is added in shopping cart correctly.
 * 8. Click the '+' button twice for 'Microsoft Surface Laptop 4'.
 * 9. Verify that the total price is changed correctly.
 */
public class TC_023_LP_002 extends Hooks {
    ...
    void verifyWhetherCountsOfProductsDisplayedInShoppingCartCorrect(){
        ...
        boolean areTheseProductsAddedToShoppingCart = pages.getLaptopsPage().areTheseProductsAddedToShoppingCart("Microsoft Surface Laptop 4");
        softAssert.assertTrue(areTheseProductsAddedToShoppingCart, "There should be only one product in the shopping cart but there is not");
        ...
        softAssert.assertTrue(isTotalPriceInShoppingCartCorrect, "Total price in shopping cart does not match with the total price of product(s)");
    }
}