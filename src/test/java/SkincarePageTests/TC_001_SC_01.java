...
/**
 * 1. Click the Skincare item 2. Verify you are on the Skincare page 3. Click on the add
 * to cart button in Skin Beauty Serum 4. Verify "Product added to cart!"message was
 * displayed
 */

public class TC_001_SC_01 extends Hooks {
