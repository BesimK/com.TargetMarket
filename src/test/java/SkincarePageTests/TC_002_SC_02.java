...
/**
 * 1.Click the Skincare item 2.Verify you are on the Skincare Page 3.Select the highest
 * price in sort by dropdown 4.Verify that the products are sorted from expensive to cheap
 */

public class TC_002_SC_02 extends Hooks {
