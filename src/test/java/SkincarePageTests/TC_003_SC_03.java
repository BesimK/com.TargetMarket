...
public class TC_003_SC_03 extends Hooks {
	...
	/**
	 * 1. Click the Skincare item 2. Verify you are on the Skincare page 3. Click on the
	 * add to cart button in Skin Beauty Serum 4. Click on the add to cart button in Tree
	 * Oil 30ml 5. Click on shopping cart button. 6. Click on "Go to Checkout" button and
	 * navigate to Checkout page. 7. Verify that product added to cart.
	 */
