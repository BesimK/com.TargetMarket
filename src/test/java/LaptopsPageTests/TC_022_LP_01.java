...
/**
 * 1. Open the URL. 2. Navigate to Target Market Login Page. 3. Fill in the blanks with
 * the provided credentials. (problem_user) 4. Navigate to Target Market Home Page. 5.
